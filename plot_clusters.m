...
% plot_clusters does the plot of: - the points in data changing the colour
% according to the cluster to which they are assigned, - the centres of the
% clusters in black
hold on
...
for i = 1:size(cluster,1)
    ...
    plot(data(cluster == i,1), data(cluster == i,2), '*', 'Color', c, ...
        'MarkerSize', 3)
end
% plot the centres
